...
helpMessage ="""อ๊อฟ บอท(s)
Use Prefix 「อ๊อฟ 」 to use the Bot(s)
...
KAC=[cl,ki,kk,kc]
mid = cl.getProfile(ub9a9df4a8ca2b87a626dc46262408bb3).mid
Amid = kk.getProfile(udee626454be8e869860bbcbbdb1139d0).mid
Bmid = ki.getProfile().mid
Cmid = kc.getProfile().mid
Bots = [mid,Amid,Bmid,Cmid,]
admin = ["ub9a9df4a8ca2b87a626dc46262408bb3","udee626454be8e869860bbcbbdb1139d0"
staff = ["ub9a9df4a8ca2b87a626dc46262408bb3","udee626454be8e869860bbcbbdb1139d0"
